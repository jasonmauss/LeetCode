...
const evaluateTree = (root: TreeNode | null): boolean => {
    ...
    let boolLeft:Boolean;
    let boolRight:Boolean;
...
// some test cases
let rootNode:TreeNode = new TreeNode(2,
...
let rootNode2:TreeNode = new TreeNode(0, null, null);
console.log(evaluateTree(rootNode2)); // false

let rootNode3:TreeNode = new TreeNode(3,
    new TreeNode(3,
        new TreeNode(0, null, null
        ),
        new TreeNode(0, null, null
